class MyFilter():
    """Class for creating an object that communicates with and controls a filter-type device"""

    def __init__(self, name, serial, enable=False):
        """Create a new Filter object for easy communication with the device concerned
